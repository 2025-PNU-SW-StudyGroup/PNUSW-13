...
### 2025 SW중심대학 디지털 경진대회 : SW부문
  ...
  - [디지털경진대회 리더보드](https://dacon.io/competitions/official/236474/leaderboard)
    - 해당 링크 내 리더보드 순위로 시상 확인 가능합니다. 리더보드 내 상위 12팀 이내 Pilltip이 포함되어 있습니다.
    - 시상식이 8/12, 본선 참가증명서가 8/14부터 출력가능하므로 예선 참가증명서로 갈음합니다.
